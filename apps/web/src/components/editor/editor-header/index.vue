...
const PngExportDialog = defineAsyncComponent(() => import('@/components/editor/dialogs/PngExportDialog.vue'))
...
const { isOpenRightSlider, isShowSyncDialog, isShowAccountDialog, isShowShareDialog, isShowPdfExportDialog, isShowPngExportDialog, isShowAboutDialog, isShowFundDialog, isShowEditorStateDialog, isShowPreferencesDialog, isShowMarkdownHelpDialog, isShowKeyboardShortcutsDialog, copyMode } = storeToRefs(uiStore)
...
<template>
  ...
  <PngExportDialog v-if="isShowPngExportDialog" v-model:open="isShowPngExportDialog" />
</template>
