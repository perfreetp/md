export default {
  ...
  longImageExport: {
    title: `长图导出`,
    description: `把当前渲染效果导出为长图，可模拟不同设备宽度并添加文字水印。`,
    device: {
      label: `设备宽度`,
      mobile: `手机`,
      tablet: `平板`,
    ...
    export: `导出长图`,
    exporting: `导出中…`,
    progressPreparing: `正在准备导出…`,
    progress: `正在导出图片 {done}/{total}…`,
    done: `导出完成，共 {count} 张图片`,
    empty: `没有可导出的内容`,
    failed: `导出失败：{message}`,
  },
  exportHistory: {
    title: `导出记录`,
    description: `最近导出的长图记录，可预览、重新下载或删除。`,
    empty: `暂无导出记录`,
    preview: `预览`,
    closePreview: `关闭预览`,
    download: `重新下载`,
